...
import { categoryLabels, statusColors, statusLabels, formatDateTime, priorityColors, priorityLabels, categoryIcons } from '@/lib/utils'
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="mb-10 flex items-baseline justify-between">
          <div>
            ...
            <h1 className="font-display text-4xl font-bold text-ink">Complaints Dashboard</h1>
          </div>
          <Link href="/" className="font-mono text-sm text-ink/50 hover:text-ink">← Public View</Link>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-10">
          {[
            ...
            { label: 'Pending', value: stats.pending, color: 'bg-amber text-ink' },
        ...
        <div className="card-paper overflow-hidden">
          <div className="px-6 py-4 border-b border-ink/10 flex items-center justify-between">
            <h2 className="font-display text-xl font-bold">All Complaints</h2>
            <span className="font-mono text-sm text-ink/50">{complaints.length} records</span>
          </div>
